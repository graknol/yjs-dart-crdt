...
void main() {
  ...
  print(
      '  Alices view - Progress: ${overallProgress.value}%'); // 15% (her view)
  ...
  print(
      '  Progress: ${finalProgress.value}%'); // Alice(15) + Bob(35) + Charlie(20) = 70%
  ...
  print(
      '  All equal? ${counter1.value == counter2.value && counter2.value == counter3.value}');
  ...
  print('\n=== Summary ===');
  print(
      '✅ Multi-client collaboration: Alice, Bob, Charlie worked concurrently');
  print(
      '✅ Counter CRDTs: Tracked progress, hours, and bugs across all clients');
